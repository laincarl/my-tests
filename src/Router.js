...
import { Home, NotFoundPage,  Anchor, ComponentVSfunction, CssAnchor, Dragreact, Flooks, HooksWithProvider, Kanban, List, Main, Material, MiniMap, Modal, PortfolioPlanView, Quill, ResizeAble, ResizeDivider, Rxjs, Schedule, StickDOM, Svg, TableInfinity, TabRoute, Tabs, TimeLine, Tooltip, TreeRender, Virtualized, WorkLoad } from './test-cases';
const PageSet = () => (
  <Switch>
...
<Route path="/MiniMap" component={MiniMap} />

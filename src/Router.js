...
import { Home, NotFoundPage,  Anchor, Dragreact, Main, Material, Modal, PortfolioPlanView, ResizeAble, ResizeDivider, Schedule, StickDOM, TableInfinity, Tabs, TimeLine, TreeRender, WorkLoad } from './test-cases';
const PageSet = () => (
  <Switch>

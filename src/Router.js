...
import { Home, NotFoundPage,  Animation, CssModule, CssModule2, CssModule3, DomToImage, Drag, Main, Modal, MyPagination, TableNest, TableCol, TableDrag, TreeShape } from './test-cases';
const PageSet = () => (
  <Switch>
